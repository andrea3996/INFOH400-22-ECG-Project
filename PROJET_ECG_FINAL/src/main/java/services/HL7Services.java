...
public class HL7Services {
    ...
    public SendADTResults createAndSendADT_A01(String patient, String text, Integer valueOf) {
    ...
    private ADT_A01 createADT_A01(Patient patient){
        ...
        try {
            ...
            PID pid = adt.getPID();
            pid.getPatientName(0).getFamilyName().getSurname().setValue(patient.getIdperson().getlastName());
